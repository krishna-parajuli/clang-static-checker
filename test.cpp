...
int callPerson3(string name, int phoneNum, string message3, int count, abc dcf); //the static analysis would issue a warning on the terminal for this function, because it has more than 3 parameters
